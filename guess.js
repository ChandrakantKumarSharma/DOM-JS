...
function generateRandomInteger(max) {
  ...
  function maincheck(){
    ...
    if(initialscore!==0){
       ...
       document.querySelector('.message').textContent="Your Guess is to High Ji"
           initialscore--
         document.querySelector('.score').textContent=initialscore
       }
       else if(inputnumber<randomnumber){
        document.querySelector('.message').textContent="Your Guess is to Low Ji"
        initialscore--
        document.querySelector('.score').textContent=initialscore
       }
       else{

        document.querySelector('.message').textContent="You Won the Game Thank you!!"
        ...
        document.querySelector('.message').textContent="Game Over You Won 0"
